            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> View Records<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="order_info.php"><i class="fa fa-table fa-fw"></i> Order Information</a>
                        </li>
                        <li>
                            <a href="order.php"><i class="fa fa-edit fa-fw"></i> Sign Up Order</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="notifications.php">Customer Utang</a>
                                </li>
                                <li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="blank.php">Visit Us</a>
                                </li>
                                <li>
