            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
			            ...
			            $search = $_POST['search'];
			            $data = "SELECT * FROM user WHERE name like '%".$search."%' ";
		                 }else{
			            ...
			            <td><a href="update_customer.php?update=<?php echo $rs['user_id']; ?>">Update</a> | <a href="customer_list.php?x=<?php echo $rs['user_id'];?>">Delete</a></td>
		                </tr>
		                <?php $count++; }?>
                            </table>
                            <!-- /.table-responsive -->
