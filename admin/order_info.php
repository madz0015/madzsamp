            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
			            ...
			            $search = $_POST['search'];
			            $data = "SELECT * FROM order_tbl WHERE name like '%".$search."%' ";
		                 }else{
			            $data = "SELECT * FROM order_tbl";
		                }
			            ...
			            <td><a href="update_order.php?update=<?php echo $rs['user_id']; ?>">Update</a> | <a href="order_info.php?x=<?php echo $rs['user_id'];?>">Delete</a></td>
		                </tr>
		                <?php $count++; }?>
                            </table>
                            <!-- /.table-responsive -->
