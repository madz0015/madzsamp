            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
			            ...
			            $search = $_POST['search'];
			            $data = "SELECT * FROM product_tbl WHERE name like '%".$search."%' ";
		                 }else{
			            $data = "SELECT * FROM product_tbl";
		                }
			            ...
			            <td><?php echo $rs['expiry_date']?></td>
			            <td><a href="update_product.php?update=<?php echo $rs['shop_id']; ?>">Update</a> | <a href="product_list.php?x=<?php echo $rs['shop_id'];?>">Delete</a></td>
		                </tr>
		                <?php $count++; }?>
                            </table>
                            <!-- /.table-responsive -->
