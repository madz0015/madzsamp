...
<body style="background-image: url('images/shops.jpg')">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background-image: url('images/shops.jpg')">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">About M&A Store</h1>
                </div>
                <div><b>Visit Us At:
                    <h1>Southern City Colleges Central Campus Pilar St. Zamboanga City, Philippines</h1>
                    <h1>Souther City Colleges East Campus Divisoria, Zamboanga City, Philippines</h1>
                    <h1>Souther City Colleges West Campus San Jose Gusu, Zamboanga City, Philippines</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
