...
<?php
	if (isset($_GET['update'])){
		$fetch = "SELECT * FROM order_tbl WHERE user_id='".$_GET['update']."'";
...
if (isset($_POST['update'])) {
    ...
    $update = "UPDATE order_tbl SET name='$name',address='$address',age='$age',product='$product',quantity='$quantity' WHERE user_id ='".$_GET['update']."'";
    
    $data = mysqli_query($conn, $update);

    echo "<script language = Javascript>;
        alert('Record Updated!');
        location.href='order_info.php';
        </script>";
}
