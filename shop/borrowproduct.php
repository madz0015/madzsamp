                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter product" name="txtproduct" type="text" value="">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter desire quantity" name="txtquantity" type="text" value="">
                                </div>
                                <div class="form-group">
...
if (isset($_POST['register'])) {
    ...
    $sql = "Insert into borrows_tbl (name,address,age,product,quantity) values
