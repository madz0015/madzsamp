...
<body style="background-image: url('images/shopi.jpg')">
<form method="post">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Store Login</h3>
                    </div>
                    <div class="panel-body" style="background-image: url('images/shopi.jpg')">
                        <form role="form">
                            <fieldset>
...
if (isset($_POST['login'])) {
	...
	if($rows >=1) {
        ...
        echo "<script language = Javascript>;
        alert('Woii Wrong Password Balikan Mo..!!');
